function saveFileName = test_uniform_ord_vs_scale(quantRate)
%TEST_UNIFORM_ORD_VS_SCALE simulates recon. from quantized measurements
% It is intended to test whether, and possibly how much, it can improve
% compressed sensing reconstruction from (uniformly) quantized measurements
...
[part,cb] = bpdq_gauss_unif(2^quantRate);
part = part(2:end-1)';
cb = cb';
spgopts = spgSetParms('verbosity',0);
alpha = 1-beta_u(quantRate);
